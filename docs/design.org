...
** Scalability & Security
   ...
   3. The design must scale up to 10,000 managed nodes per OPC server.
...
*** Heartbeat Channel
    NOTE: Rewrite this to account for merged command/client heartbeat channel
...
#+INCLUDE: "design_rest_api.org" :minlevel 1

#+INCLUDE: "design_zeromq_messages.org" :minlevel 1
